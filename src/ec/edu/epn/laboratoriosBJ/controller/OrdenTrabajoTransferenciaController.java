...
public class OrdenTrabajoTransferenciaController implements Serializable {
	...
	public boolean buscarDetalleOT(Detalleorden detalleorden) {
		...
		System.err.println("Esto es el numero de veces que existe un servicio: " + i
				+ " y este es le numero total de muestras: " + nuevoOrdenTrabajo.getNumeromuestraOt());
	...
	public void cargarDetalleProformaEdit(OrdenTrabajo o, String panel) {
		...
		if (o.getEstadoOt().equals("CLOSED")) {
			...
			System.out.println("Lista de detallesPro id: " + o.getIdOrden());
